...
class Zend_Search_Lucene_Search_QueryLexer extends Zend_Search_Lucene_FSM
{
    ...
    {
        parent::__construct( [self::ST_WHITE_SPACE, self::ST_SYNT_LEXEME, self::ST_LEXEME, self::ST_QUOTED_LEXEME, self::ST_ESCAPED_CHAR, self::ST_ESCAPED_QCHAR, self::ST_LEXEME_MODIFIER, self::ST_NUMBER, self::ST_MANTISSA, self::ST_ERROR],
        ...
        $this->addRules([
            [self::ST_LEXEME, self::IN_WHITE_SPACE, self::ST_WHITE_SPACE],
        ...
        $this->addRules([[self::ST_QUOTED_LEXEME, self::IN_WHITE_SPACE, self::ST_QUOTED_LEXEME], [self::ST_QUOTED_LEXEME, self::IN_SYNT_CHAR, self::ST_QUOTED_LEXEME], [self::ST_QUOTED_LEXEME, self::IN_MUTABLE_CHAR, self::ST_QUOTED_LEXEME], [self::ST_QUOTED_LEXEME, self::IN_LEXEME_MODIFIER, self::ST_QUOTED_LEXEME], [self::ST_QUOTED_LEXEME, self::IN_ESCAPE_CHAR, self::ST_ESCAPED_QCHAR], [self::ST_QUOTED_LEXEME, self::IN_QUOTE, self::ST_WHITE_SPACE], [self::ST_QUOTED_LEXEME, self::IN_DECIMAL_POINT, self::ST_QUOTED_LEXEME], [self::ST_QUOTED_LEXEME, self::IN_ASCII_DIGIT, self::ST_QUOTED_LEXEME], [self::ST_QUOTED_LEXEME, self::IN_CHAR, self::ST_QUOTED_LEXEME]]);
        $this->addRules([[self::ST_ESCAPED_CHAR, self::IN_WHITE_SPACE, self::ST_LEXEME], [self::ST_ESCAPED_CHAR, self::IN_SYNT_CHAR, self::ST_LEXEME], [self::ST_ESCAPED_CHAR, self::IN_MUTABLE_CHAR, self::ST_LEXEME], [self::ST_ESCAPED_CHAR, self::IN_LEXEME_MODIFIER, self::ST_LEXEME], [self::ST_ESCAPED_CHAR, self::IN_ESCAPE_CHAR, self::ST_LEXEME], [self::ST_ESCAPED_CHAR, self::IN_QUOTE, self::ST_LEXEME], [self::ST_ESCAPED_CHAR, self::IN_DECIMAL_POINT, self::ST_LEXEME], [self::ST_ESCAPED_CHAR, self::IN_ASCII_DIGIT, self::ST_LEXEME], [self::ST_ESCAPED_CHAR, self::IN_CHAR, self::ST_LEXEME]]);
        $this->addRules([[self::ST_ESCAPED_QCHAR, self::IN_WHITE_SPACE, self::ST_QUOTED_LEXEME], [self::ST_ESCAPED_QCHAR, self::IN_SYNT_CHAR, self::ST_QUOTED_LEXEME], [self::ST_ESCAPED_QCHAR, self::IN_MUTABLE_CHAR, self::ST_QUOTED_LEXEME], [self::ST_ESCAPED_QCHAR, self::IN_LEXEME_MODIFIER, self::ST_QUOTED_LEXEME], [self::ST_ESCAPED_QCHAR, self::IN_ESCAPE_CHAR, self::ST_QUOTED_LEXEME], [self::ST_ESCAPED_QCHAR, self::IN_QUOTE, self::ST_QUOTED_LEXEME], [self::ST_ESCAPED_QCHAR, self::IN_DECIMAL_POINT, self::ST_QUOTED_LEXEME], [self::ST_ESCAPED_QCHAR, self::IN_ASCII_DIGIT, self::ST_QUOTED_LEXEME], [self::ST_ESCAPED_QCHAR, self::IN_CHAR, self::ST_QUOTED_LEXEME]]);
        $this->addRules([
        ...
        $this->addRules([
            [self::ST_MANTISSA, self::IN_WHITE_SPACE, self::ST_WHITE_SPACE],
    ...
    public function tokenize($inputString, $encoding)
    {
        ...
        for ($this->_queryStringPosition = 0;
             $this->_queryStringPosition < count((array) $this->_queryString);
    ...
    public function addQuerySyntaxLexeme()
    {
        ...
        if (strpos(self::QUERY_DOUBLECHARLEXEME_CHARS, $lexeme) !== false) {
            ...
            // check,
            if ($this->_queryStringPosition == count((array) $this->_queryString)  ||
