 ...
 */
 ...
 $GLOBALS['ACLActionAccessLevels'] = [
     ...
     /* BEGIN - SECURITY GROUPS */
     ACL_ALLOW_GROUP=>['color'=>'#0000A0', 'label'=>'LBL_ACCESS_GROUP', 'text_color'=>'white'],
 ];
/**
 * $GLOBALS['ACLActions
...
$GLOBALS['ACLActions'] = ['module'=>['actions'=>
						['access'=>
								...
								['aclaccess'=>[ACL_ALLOW_ALL, ACL_ALLOW_GROUP, ACL_ALLOW_OWNER, ACL_ALLOW_DEFAULT, ACL_ALLOW_NONE], 'label'=>'LBL_ACTION_VIEW', 'default'=>ACL_ALLOW_ALL], 'list'=>
								['aclaccess'=>[ACL_ALLOW_ALL, ACL_ALLOW_GROUP, ACL_ALLOW_OWNER, ACL_ALLOW_DEFAULT, ACL_ALLOW_NONE], 'label'=>'LBL_ACTION_LIST', 'default'=>ACL_ALLOW_ALL], 'edit'=>
								['aclaccess'=>[ACL_ALLOW_ALL, ACL_ALLOW_GROUP, ACL_ALLOW_OWNER, ACL_ALLOW_DEFAULT, ACL_ALLOW_NONE], 'label'=>'LBL_ACTION_EDIT', 'default'=>ACL_ALLOW_ALL], 'delete'=>
							['aclaccess'=>[ACL_ALLOW_ALL, ACL_ALLOW_GROUP, ACL_ALLOW_OWNER, ACL_ALLOW_DEFAULT, ACL_ALLOW_NONE], 'label'=>'LBL_ACTION_DELETE', 'default'=>ACL_ALLOW_ALL], 'import'=>
							['aclaccess'=>[ACL_ALLOW_ALL, ACL_ALLOW_DEFAULT, ACL_ALLOW_NONE], 'label'=>'LBL_ACTION_IMPORT', 'default'=>ACL_ALLOW_ALL], 'export'=>
							['aclaccess'=>[ACL_ALLOW_ALL, ACL_ALLOW_GROUP, ACL_ALLOW_OWNER, ACL_ALLOW_DEFAULT, ACL_ALLOW_NONE], 'label'=>'LBL_ACTION_EXPORT', 'default'=>ACL_ALLOW_ALL], 'massupdate'=>
