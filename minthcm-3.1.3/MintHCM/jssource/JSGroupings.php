...
$js_groupings = [
    $sugar_grp1 = [
        ...
        'include/javascript/favico.js'                            => 'include/javascript/sugar_grp1.js',
        ...
        'include/javascript/MintHCMDynamicPopupView.js'           => 'include/javascript/sugar_grp1.js',
    ...
    $sugar_field_grp = ['include/SugarFields/Fields/Collection/SugarFieldCollection.js' => 'include/javascript/sugar_field_grp.js', 'include/SugarFields/Fields/Datetimecombo/Datetimecombo.js'     => 'include/javascript/sugar_field_grp.js'],
    $sugar_grp1_yui = [
    ...
    $sugar_grp_yui_widgets_css = ["include/javascript/yui/build/fonts/fonts-min.css"                      => 'include/javascript/sugar_grp_yui_widgets.css', "include/javascript/yui/build/treeview/assets/skins/sam/treeview.css"
    => 'include/javascript/sugar_grp_yui_widgets.css', "include/javascript/yui/build/datatable/assets/skins/sam/datatable.css"
    => 'include/javascript/sugar_grp_yui_widgets.css', "include/javascript/yui/build/container/assets/skins/sam/container.css"
    => 'include/javascript/sugar_grp_yui_widgets.css', "include/javascript/yui/build/button/assets/skins/sam/button.css"
        => 'include/javascript/sugar_grp_yui_widgets.css', "include/javascript/yui/build/calendar/assets/skins/sam/calendar.css"
    ...
    $sugar_grp_quick_compose = [
        ...
        'include/SugarFields/Fields/Collection/SugarFieldCollection.js' => 'include/javascript/sugar_grp_quickcomp.js',
        //For team selection
        ...
        'modules/Emails/javascript/grid.js'                             => 'include/javascript/sugar_grp_quickcomp.js',
        //For address book
    ...
    $sugar_grp_jsolait = ['include/javascript/jsclass_base.js'    => 'include/javascript/sugar_grp_jsolait.js', 'include/javascript/jsclass_async.js'   => 'include/javascript/sugar_grp_jsolait.js', 'modules/Meetings/jsclass_scheduler.js' => 'include/javascript/sugar_grp_jsolait.js'],
    $sugar_grp_project = ['include/javascript/jsclass_base.js'   => 'include/javascript/sugar_grp_project.js', 'include/javascript/jsclass_async.js'  => 'include/javascript/sugar_grp_project.js', 'modules/Project/jsclass_scheduler.js' => 'include/javascript/sugar_grp_project.js'],
    $sugar_grp_project_template = ['include/javascript/jsclass_base.js'               => 'include/javascript/sugar_grp_project_template.js', 'include/javascript/jsclass_async.js'              => 'include/javascript/sugar_grp_project_template.js', 'modules/AM_ProjectTemplates/jsclass_scheduler.js' => 'include/javascript/sugar_grp_project_template.js'],
];
$group_file_name1 = 'include/javascript/sugar_grp1.js';
if ( isset($GLOBALS['sugar_config']['developerMode']) && $GLOBALS['sugar_config']['developerMode'] ) {
   $sugar_grp1 = array_merge($sugar_grp1, ['/include/ViewTools/javascript/viewTools_developermode.js' => $group_file_name1]);
} else {
   $sugar_grp1 = array_merge($sugar_grp1, ['/include/ViewTools/javascript/viewTools.js' => $group_file_name1, '/include/ViewTools/javascript/viewTools.cache.js' => $group_file_name1, '/include/ViewTools/javascript/viewTools.init.js' => $group_file_name1, '/include/ViewTools/javascript/moment.min.js' => $group_file_name1]);
}
