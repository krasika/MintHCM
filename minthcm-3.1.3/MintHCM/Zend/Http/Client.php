...
class Zend_Http_Client
{
     ...
     * @var array
     */
    protected $config = ['maxredirects'    => 5, 'strictredirects' => false, 'useragent'       => 'Zend_Http_Client', 'timeout'         => 10, 'adapter'         => 'Zend_Http_Client_Adapter_Socket', 'httpversion'     => self::HTTP_1, 'keepalive'       => false, 'storeresponse'   => true, 'strict'          => true, 'output_stream'   => false, 'encodecookies'   => true];
    ...
    public function setAuth($user, $password = '', $type = self::AUTH_BASIC)
    {
        ...
        // Else, set up authentication
            ...
            $this->auth = ['user' => (string) $user, 'password' => (string) $password, 'type' => $type];
        }
    ...
    public function setFileUpload($filename, $formname, $data = null, $ctype = null)
    {
        ...
        $this->files[] = ['formname' => $formname, 'filename' => basename($filename), 'ctype'    => $ctype, 'data'     => $data];
