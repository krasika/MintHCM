...
class Zend_Gdata_App
{
     ...
     * @var array
     */
    protected $_registeredPackages = ['Zend_Gdata_App_Extension', 'Zend_Gdata_App'];
        ...
        $applicationId = 'MyCompany-MyApp-1.0')
    {
        ...
        $client->setConfig(['strictredirects' => true]
        );
                                   ...
                                   $contentTypeOverride = null)
    {
        ...
        return ['method' => $method, 'url' => $url, 'data' => $rawData, 'headers' => $headers, 'contentType' => $finalContentType];
    }
    ...
    {
        $this->_httpClient->setConfig(['adapter' => 'Zend_Gdata_App_LoggingHttpClientAdapterSocket', 'logfile' => $logfile]);
    }
