...
class Zend_Gdata_YouTube extends Zend_Gdata_Media
{
     ...
     * @var array
     */
    public static $namespaces = [['yt', 'http://gdata.youtube.com/schemas/2007', 1, 0], ['georss', 'http://www.georss.org/georss', 1, 0], ['gml', 'http://www.opengis.net/gml', 1, 0], ['media', 'http://search.yahoo.com/mrss/', 1, 0]];
    ...
    public static function parseFormUploadTokenResponse($response)
    {
        ...
        if ($tokenText != null && $urlText != null) {
            return ['token' => $tokenText, 'url' => $urlText];
        } else {
            require_once 'Zend/Gdata/App/Exception.php';
            throw new Zend_Gdata_App_Exception(
