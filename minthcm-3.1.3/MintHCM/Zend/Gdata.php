...
class Zend_Gdata extends Zend_Gdata_App
{
     ...
     * @var array
     */
    protected $_registeredPackages = ['Zend_Gdata_Kind', 'Zend_Gdata_Extension', 'Zend_Gdata', 'Zend_Gdata_App_Extension', 'Zend_Gdata_App'];
     ...
     * @var array
     */
    public static $namespaces = [['gd', 'http://schemas.google.com/g/2005', 1, 0], ['openSearch', 'http://a9.com/-/spec/opensearchrss/1.0/', 1, 0], ['openSearch', 'http://a9.com/-/spec/opensearch/1.1/', 2, 0], ['rss', 'http://blogs.law.harvard.edu/tech/rss', 1, 0]];
