...
class ImapHandlerOAuth2 implements ImapHandlerInterface
{
    ...
    public function open($mailbox, $username, $password, $options = 0, $n_retries = 0, $params = null)
    {
        ...
        $this->setStream(@imap2_open($mailbox, $username, $access_token, $options | OP_XOAUTH2));
    ...
    public function sort($criteria, $reverse, $options = 0, $search_criteria = null, $charset = null)
    {
        ...
        $call = function($charset) use ($criteria, $reverse, $options, $search_criteria){
          return imap2_sort($this->getStream(), $criteria, $reverse, $options, $search_criteria, $charset);
        };
    ...
    {
        $this->logCall(__FUNCTION__, func_get_args());
        $ret = imap2_fetchbody($this->getStream(), $msg_number, $section, $options);
        $this->logReturn(__FUNCTION__, $ret);
    ...
    {
        $this->logCall(__FUNCTION__, func_get_args());
        $ret = imap2_fetch_overview($this->getStream(), $sequence, $options);
        $this->logReturn(__FUNCTION__, $ret);
