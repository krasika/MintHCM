	...
	protected function registerTypes()
	{
		...
		$this->serviceClass->registerType(
			...
			'complexType',
		   	 ...
		   	 'all',
		  	  '',
				['name'=>['name'=>'name', 'type'=>'xsd:string'], 'records'=>['name'=>'records', 'type'=>'tns:search_link_array_list']]
		);
		...
		$this->serviceClass->registerType(
			...
			'complexType',
		   	 ...
		   	 'all',
		  	  '',
				['module_key'=>['name'=>'module_key', 'type'=>'xsd:string'], 'module_label'=>['name'=>'module_label', 'type'=>'xsd:string'], 'favorite_enabled'=>['name'=>'favorite_enabled', 'type'=>'xsd:boolean'], 'acls'=>['name'=>'acls', 'type'=>'tns:acl_list']]
		);
		...
		$this->serviceClass->registerType(
			...
			'complexType',
		   	 ...
		   	 'all',
		  	  '',
				['module_name'=>['name'=>'module_name', 'type'=>'xsd:string'], 'table_name'=>['name'=>'table_name', 'type'=>'xsd:string'], 'module_fields'=>['name'=>'module_fields', 'type'=>'tns:field_list'], 'link_fields'=>['name'=>'link_fields', 'type'=>'tns:link_field_list']]
		);
	}
}
