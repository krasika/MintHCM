...
class registry_v3 extends registry {
	...
	protected function registerTypes() {
		...
		$this->serviceClass->registerType(
		    ...
		    'all',
		    '',
		    ["id" => ['name'=>"id", 'type'=>'xsd:string'], "module" => ['name'=>"module", 'type'=>'xsd:string'], "date_due" => ['name'=>"date_due", 'type'=>'xsd:string'], "summary" => ['name'=>"summary", 'type'=>'xsd:string']]
		);
	    ...
	    $this->serviceClass->registerType(
		    ...
		    'all',
		    '',
		    ["id" => ['name'=>"id", 'type'=>'xsd:string'], "item_id" => ['name'=>"item_id", 'type'=>'xsd:string'], "item_summary" => ['name'=>"item_summary", 'type'=>'xsd:string'], "module_name" => ['name'=>"module_name", 'type'=>'xsd:string'], "monitor_id" => ['name'=>"monitor_id", 'type'=>'xsd:string'], "date_modified" => ['name'=>"date_modified", 'type'=>'xsd:string']]
		);
		...
		$this->serviceClass->registerType(
			...
			'complexType',
		   	 ...
		   	 'all',
		  	  '',
				['name'=>['name'=>'name', 'type'=>'xsd:string'], 'type'=>['name'=>'type', 'type'=>'xsd:string'], 'group'=>['name'=>'group', 'type'=>'xsd:string'], 'label'=>['name'=>'label', 'type'=>'xsd:string'], 'required'=>['name'=>'required', 'type'=>'xsd:int'], 'options'=>['name'=>'options', 'type'=>'tns:name_value_list'], 'default_value'=>['name'=>'name', 'type'=>'xsd:string']]
		);
	}
}
