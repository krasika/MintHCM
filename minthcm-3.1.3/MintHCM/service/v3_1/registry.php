	...
	protected function registerTypes() 
	{
	    ...
	    $this->serviceClass->registerType(
			...
			'complexType',
		   	 ...
		   	 'all',
		  	  '',
				['module_key'=>['name'=>'module_key', 'type'=>'xsd:string'], 'module_label'=>['name'=>'module_label', 'type'=>'xsd:string'], 'acls'=>['name'=>'acls', 'type'=>'tns:acl_list']]
		);
		...
		$this->serviceClass->registerType(
			...
			'complexType',
		   	 ...
		   	 'all',
		  	  '',
				['action'=>['name'=>'action', 'type'=>'xsd:string'], 'access'=>['name'=>'access', 'type'=>'xsd:string']]
		);
		...
		$this->serviceClass->registerType(
		   	 ...
		   	 'all',
		  	  '',
			['result_count' => ['name'=>'result_count', 'type'=>'xsd:int'], 'total_count' => ['name'=>'total_count', 'type'=>'xsd:int'], 'next_offset' => ['name'=>'next_offset', 'type'=>'xsd:int'], 'entry_list' => ['name' =>'entry_list', 'type'=>'tns:entry_list'], 'relationship_list' => ['name' =>'relationship_list', 'type'=>'tns:link_lists']]
		);
		...
		$this->serviceClass->registerType(
			...
			'complexType',
		   	 ...
		   	 'all',
		  	  '',
				['module_name'=>['name'=>'module_name', 'type'=>'xsd:string'], 'module_name'=>['name'=>'table_name', 'type'=>'xsd:string'], 'module_fields'=>['name'=>'module_fields', 'type'=>'tns:field_list'], 'link_fields'=>['name'=>'link_fields', 'type'=>'tns:link_field_list']]
		);
